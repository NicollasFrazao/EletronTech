...
function Add(){
	...
	if(itemSelecionado == 0){
		...
		var opt2 = document.createElement("option");
		opt2.value = "2";
		opt2.text = "Microohm (µO)";
		cmb_unidadeInicial.add(opt2, cmb_unidadeInicial.options[2]);

		var op2 = document.createElement("option");
		op2.value = "2";
		op2.text = "Microohm (µO)";
		cmb_unidadeFinal.add(op2, cmb_unidadeFinal.options[2]);

		var opt3 = document.createElement("option");
		opt3.value = "3";
		opt3.text = "Miliohm (mO)";
		cmb_unidadeInicial.add(opt3, cmb_unidadeInicial.options[3]);
...
function Calc(){
	...
	if(itemSelecionado == 1){
		...
		txt_valorFinal.value = cav[ufItem].toString().replace(".", ",");
	}
	...
	else if (itemSelecionado == 2)
	{
		...
		txt_valorFinal.value = condVet[ufItem].toString().replace(".", ",");
	}
	...
	else if (itemSelecionado == 3)
	{
		...
		{
			corVet[1] = vlInicial * 10000000000;
		}
		...
		corVet[3] = corVet[1] / 1000000;
		corVet[4] = corVet[1] / 1000000000;
		corVet[5] = corVet[1] / 1000000000000;
		corVet[6] = corVet[1] / 1000000000000000;
		corVet[7] = corVet[1] / 1000000000000000000;
		corVet[8] = corVet[1] / 1000000000;
		corVet[9] = corVet[1] / 1000000000;

		txt_valorFinal.value = corVet[ufItem].toString().replace(".", ",");
	}
	...
	else if (itemSelecionado == 4)
	{
		...
		indVet[8] = indVet[1] / 1000000000;
		indVet[9] = indVet[1] / 1000000000;

		txt_valorFinal.value = indVet[ufItem].toString().replace(".", ",");
	}
	...
	else if (itemSelecionado == 5)
	{
		...
		txt_valorFinal.value = potVet[ufItem].toString().replace(".", ",");
	}
	...
	else if (itemSelecionado == 6)
	{
		...
		txt_valorFinal.value = resVet[ufItem].toString().replace(".", ",");
	}
}
