...
function Ajuda()
{
	alert("Selecionando o cômodo desejado, e inserindo as medidas de Largura(m) e Comprimento(m) deste cômodo, é calculada a potência total para iluminar a área apresentada.");
}
