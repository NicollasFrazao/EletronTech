...
function Calcular()
{
	...
	largura = txt_largura.value.replace(txt_largura.getAttribute('unidade'), "").trim();
	comprimento = txt_comprimento.value.replace(txt_comprimento.getAttribute('unidade'), "").trim();
