<?php
	...
	$caminho = 'Users/'.$codigo.'/imagem-capa/';
	$auxcaminho = 'Users/'.$codigo.'/imagem-capa';
	$auxFoto = 0;
	...
	$auxpastaimagem = '../Users/'.$codigo.'/imagem-capa';
	$auxnome = 'imagem-capa';
	$pastaRaiz = $_SESSION['EletronTech']['pastaRaiz'];
			
	$_UP['pasta'] = '../Users/'.$codigo.'/imagem-capa/';
		...
		<script>
			...
			<?php
				...
				if (isset($_FILES['foto']))
				{
					...
					{
						$query = mysql_query("update tb_usuario set im_capa = '$foto' where cd_usuario = '$codigo'");
